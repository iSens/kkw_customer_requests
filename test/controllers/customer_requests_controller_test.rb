...
class CustomerRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create customer_request" do
    assert_difference('CustomerRequest.count') do
      post customer_requests_url, params: { customer_request: { brand: @customer_request.brand, customer_name: @customer_request.customer_name, customer_phone: @customer_request.customer_phone, deposit: @customer_request.deposit, notes: @customer_request.notes, status: @customer_request.status } }
    end
  ...
  test "should update customer_request" do
    patch customer_request_url(@customer_request), params: { customer_request: { brand: @customer_request.brand, customer_name: @customer_request.customer_name, customer_phone: @customer_request.customer_phone, deposit: @customer_request.deposit, notes: @customer_request.notes, status: @customer_request.status } }
